...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_deidentification = QtWidgets.QPushButton(Form)
        self.btn_deidentification.setObjectName("btn_deidentification")
        self.btn_deidentification.setText("De-identification")
        self.verticalLayout.addWidget(self.btn_deidentification)  # Add 버튼 위에 추가
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "De-identification Project / Team11"))
        ...
        self.btn_deidentification.setText(_translate("Form", "De-identification"))
        self.btn_add.setText(_translate("Form", "Add(5분 이내 영상만!)"))
